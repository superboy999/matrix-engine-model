'''
Author: superboy
Date: 2024-09-09 01:59:52
LastEditTime: 2024-09-20 18:52:17
LastEditors: superboy
Description: 
FilePath: /gem5-rvm/configs/example/512.py
...
# GENERAL OPTIONS
ps.add_option('--cmd',              type="string", default="/cluster/home/chenwq/research/rvm/simulator/run/tests/cwq/exploration/512",
...
ps.add_option('--xbuffer_ports_num',  type="int", default=16,
                                    help="XBuffer Ports Number")
ps.add_option('--ybuffer_ports_num',  type="int", default=16,
                                    help="YBuffer Ports Number")
ps.add_option('--cu_row_size',  type="int", default=16,
                                    help="Compute Unit Array row size, indicate number of row")
ps.add_option('--cu_column_size',  type="int", default=16,
...
ps.add_option('--x_num_port',  type="int", default=16,
                                    help="XBuffer Ports Number")
ps.add_option('--y_num_port',  type="int", default=16,
                                    help="YBuffer Ports Number")
ps.add_option('--z_buffer_depth',  type="int", default=64,
                                    help="ZBuffer depth")
ps.add_option('--z_num_port',  type="int", default=16,
...
ps.add_option('--bank_depth',  type="int", default=16,
...
# MATRIX ENGINE TOP
ps.add_option('--lane_num',  type="int", default=6,
