'''
Author: superboy
Date: 2024-09-08 20:47:31
LastEditTime: 2024-09-22 04:03:08
LastEditors: superboy
Description: 
FilePath: /gem5-rvm/configs/example/128.py
...
# GENERAL OPTIONS
ps.add_option('--cmd',              type="string", default="/cluster/home/chenwq/research/rvm/simulator/run/tests/cwq/exploration/128",
...
ps.add_option('--xbuffer_ports_num',  type="int", default=4,
                                    help="XBuffer Ports Number")
ps.add_option('--ybuffer_ports_num',  type="int", default=4,
                                    help="YBuffer Ports Number")
ps.add_option('--cu_row_size',  type="int", default=4,
                                    help="Compute Unit Array row size, indicate number of row")
ps.add_option('--cu_column_size',  type="int", default=4,
...
ps.add_option('--x_num_port',  type="int", default=4,
                                    help="XBuffer Ports Number")
ps.add_option('--y_num_port',  type="int", default=4,
                                    help="YBuffer Ports Number")
ps.add_option('--z_buffer_depth',  type="int", default=64,
                                    help="ZBuffer depth")
ps.add_option('--z_num_port',  type="int", default=4,
                                    help="ZBuffer Ports Number")

# MATRIX REGISTER
ps.add_option('--physicReg_num',  type="int", default=8,
                                    help="Matrix physical register number")
ps.add_option('--regWidth',  type="int", default=128,
                                    help="Matrix register width")
ps.add_option('--bank_num',  type="int", default=4,
                                    help="Matrix register bank number")
ps.add_option('--bank_depth',  type="int", default=4,
...
# MATRIX RENAME
ps.add_option('--numPhysicalRegs',  type="int", default=8,
                                    help="Matrix physical register number")
...
# MATRIX ENGINE TOP
ps.add_option('--lane_num',  type="int", default=1,
