/*
 * @Author: superboy
 * @Date: 2024-08-19 15:51:42
 * @LastEditTime: 2024-08-19 23:37:53
 * @LastEditors: superboy
 * @Description: 
 * @FilePath: /gem5-rvm/tests/cwq/transformer/tiny.c
 * 
 */
...
static void whole_matmul(uint64_t *start_addr_m0, uint64_t *start_addr_B, uint64_t *start_addr_C)
{
    ...
    mstb(1, (uint64_t *)start_addr_C+0*8*stride, stride);
    matrixmul_int8_ss(2, 0, 5);
    mstb(2, (uint64_t *)start_addr_C+1*8*stride, stride);
    matrixmul_int8_ss(3, 0, 6);
    mstb(3, (uint64_t *)start_addr_C+2*8*stride, stride);
    matrixmul_int8_ss(1, 0, 7);
    mstb(4, (uint64_t *)start_addr_C+3*8*stride, stride);
    ...
    mstb(2, (uint64_t *)start_addr_C+4*8*stride, stride);
    matrixmul_int8_ss(3, 0, 5);
    mstb(3, (uint64_t *)start_addr_C+5*8*stride, stride);
    matrixmul_int8_ss(1, 0, 6);
    mstb(1, (uint64_t *)start_addr_C+6*8*stride, stride);
    matrixmul_int8_ss(2, 0, 7);
    mstb(2, (uint64_t *)start_addr_C+7*8*stride, stride);
