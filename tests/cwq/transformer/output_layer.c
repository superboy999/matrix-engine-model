 ...
 * @LastEditTime: 2024-09-04 19:29:00
 * @LastEditors: superboy
 * @Description: 
 * @FilePath: /gem5-rvm/tests/cwq/transformer/output_layer.c
 * 
 */
...
static alignas(32) int8_t INPUT[16][32][N] = { [0 ... 16-1][0 ... 32-1][0 ... N-1] = 1 };
static alignas(32) int8_t WET[16][4000][N] = { [0 ... 16-1][0 ... 4000-1][0 ... N-1] = 1 };
